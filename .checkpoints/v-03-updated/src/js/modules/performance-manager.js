...
export class PerformanceManager {
    constructor() {
        ...
        logger.perf(`PerformanceManager: Initialized for ${this.deviceType} device`);
    ...
    setInitialPerformanceMode() {
        ...
        logger.info(`Initial performance mode: ${initialMode}`);
    }
    ...
    async initializeMobileOptimizations() {
        logger.debug('Initializing mobile optimizations...');
