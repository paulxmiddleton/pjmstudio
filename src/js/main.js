...
class HighFashionBrutalist {
    ...
    init() {
        logger.info('Initializing High Fashion Brutalist Interface...');
    ...
    initializeGeneralInteractions() {
        ...
        if (fragmentContent) {
            fragmentContent.addEventListener('click', () => {
                ...
                // Safe HTML content update - these are trusted static manifestos
                const pElement = fragmentContent.querySelector('p');
                if (pElement) {
                    pElement.innerHTML = manifestos[nextIndex]; // Static trusted content
                }
